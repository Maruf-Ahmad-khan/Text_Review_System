...
def review(text):
  ...
  return result
html_temp = """
   <div class="" style="background-color:#00BFFF;" >
   <div class="clearfix">           
   <div class="col-md-12">
   <center><p style="font-size:40px;color:white;margin-top:10px;">Machine Learning and Natural Language Processing</p></center> 
...
if st.button("About"):
  ...
  st.subheader("Student of Computer Science Engineering")
html_temp = """
